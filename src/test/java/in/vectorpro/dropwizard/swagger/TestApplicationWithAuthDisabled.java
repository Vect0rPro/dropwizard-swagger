...
public class TestApplicationWithAuthDisabled extends Application<TestConfiguration> {
    ...
    bootstrap.addBundle(
        new SwaggerBundle<TestConfiguration>() {
          ...
          protected SwaggerBundleConfiguration getSwaggerBundleConfiguration(
            ...
            swaggerBundleConfiguration.setResourcePackage("in.vectorpro.dropwizard.swagger");
